...
![Retro looking webrings picture that says "The ultimate hover webring"](https://hover.blog/wp-content/uploads/2015/07/webrings-header.png)

Retro looking webrings picture that says "The ultimate hover webring"
...
Until recently, Webring.org was still up and running. It was more a relic of early internet history than the thriving hub it once was. Since then, it has shuffled off the web, only really accessible through the [Internet Archive](https://archive.org/) ‘s [Wayback Machine](https://web.archive.org/web/2020*/webring.org).

Click through to a snapshot of [the site in 1999](https://web.archive.org/web/19991013135810/http://webring.org/) when it called itself “the shape of things to come.”

Alas, it is instead an idea whose time had come and gone.

![A screenshot of the Webring page header from 1999 which reads "The shape of things to come - WebRing"](https://hover.blog/wp-content/uploads/2021/05/Screen-Shot-2021-05-14-at-9.53.19-AM-1024x325.png)

A screenshot of the Webring page header from 1999 which reads "The shape of things to come - WebRing"